  ...
  return (
    <div className='relative w-full bg-[#135bec]/5 py-12 lg:py-16'>
      ...
      <div className='layout-container max-w-7xl mx-auto px-4 lg:px-10 relative z-10 text-center'>
        <h1 className='text-[#111318] dark:text-white text-3xl lg:text-5xl font-black leading-tight tracking-tight mb-4'>
            Liên hệ &amp; Đăng ký
        </h1>
        <p className='text-[#616f89] dark:text-gray-400 text-base lg:text-lg max-w-2xl mx-auto'>
