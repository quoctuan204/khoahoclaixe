        ...
        <FadeIn>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col items-center text-center hover:shadow-lg transition-shadow'>
              ...
              {forms?.form1Url ? (
                <a href={`${API_BASE}${forms.form1Url}`} target='_blank' rel='noreferrer' download className='w-full bg-[#135bec] hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-xl transition-colors flex items-center justify-center gap-2'><span className='material-symbols-outlined'>download</span> Tải xuống</a>
              ) : (
            ...
            <div className='bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col items-center text-center hover:shadow-lg transition-shadow'>
              ...
              {forms?.form2Url ? (
                <a href={`${API_BASE}${forms.form2Url}`} target='_blank' rel='noreferrer' download className='w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-xl transition-colors flex items-center justify-center gap-2'><span className='material-symbols-outlined'>download</span> Tải xuống</a>
              ) : (
                <button disabled className='w-full bg-gray-100 text-gray-400 font-bold py-3 px-6 rounded-xl cursor-not-allowed'>Đang cập nhật</button>
              )}
            </div>
